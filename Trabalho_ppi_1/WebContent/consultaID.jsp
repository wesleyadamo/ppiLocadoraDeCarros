		...
		<div class="table-responsive">
			<table class="table">
				...
				<tbody>
					...
					<c:forEach var="reserva" items="${result}">


						<tr>
							<td>${reserva.id}</td>
							<td>${reserva.modeloDoCarro}</td>
							<td>${reserva.idDoCliente}</td>
							<td>${reserva.renavanDoCarro}</td>
							<td>${reserva.dataInicioAluguelString}</td>
							<td>${reserva.dataFinalAluguelString}</td>
							<td>${reserva.nomeCliente}</td>
							<td>${reserva.cpfCliente}</td>
							<td>${reserva.tarifaBase}</td>
							<td>${reserva.tarifaFinal}</td>
