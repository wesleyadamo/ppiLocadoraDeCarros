...
function formSubmit()
{
		...
		var b =document.getElementById("logica").value = 'AlterarCarro';
            ...
            <form action="ControllerServlet" method="get" >
					<c:forEach var="carro" items="${carros}">
						<tr>
							...
							<td><button type="submit" onclick="formSubmit()" value="1" id="button" class="btn btn-outline-warning" >Editar</button>
								<button type="submit"  class="btn btn-outline-danger" value="2" id="button">Apagar</button></td>
						</tr>
					</c:forEach>
